...
import { getAdmins, updateAdmin, toggleCityStatus, addCategory, createAdmin } from '../controllers/governanceController.js';
...
router.post('/admin', verifyToken, requireRole('SUPERADMIN'), createAdmin);
